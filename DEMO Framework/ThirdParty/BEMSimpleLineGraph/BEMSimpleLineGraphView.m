...
#pragma mark - Modified Here
    self.YAxisLabelXOffset = self.YAxisLabelXOffset + MODIFIED_OFFSET;
...
#pragma mark - Modified Here
    UIView *backgroundYaxis = [[UIView alloc]initWithFrame:CGRectMake(0, 0, self.YAxisLabelXOffset - MODIFIED_OFFSET, self.frame.size.height)];
...
//        NSNumber *maximumValue = [NSNumber numberWithInteger:[self calculateMaximumPointValue].integerValue];
        NSNumber *minimumValue = [NSNumber numberWithInteger:[self getMinimumValue]];
        NSNumber *maximumValue = [NSNumber numberWithInteger:[self getMaximumValue]];
...
#pragma mark - Modified Here
            UILabel *labelYAxis = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.YAxisLabelXOffset - 5 - MODIFIED_OFFSET, 15)];
